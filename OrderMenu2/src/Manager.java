...
class Login extends JFrame implements KeyListener {
	...
	public Login() {
		loginFrame = new JFrame("Manager Login");
		loginLabel = new JLabel("Manager Name :");
		loginText = new JTextField("enter name", 10);
...
//initialize GUI components
	...
	public Menu() {
		menuFrame = new JFrame("Manager Menu");
		...
		// current manager logged in
		menuCashierLabel = new JLabel(" Manager on Duty : " + Login.managerName);
		menuCashierLabel.setForeground(Color.blue);
		menuCashierLabel.setFont(new Font("Verdana",Font.BOLD,14));

		menuDateLabel = new JLabel("   Date/Time : " 
								   + dateFormat.format(calendar.getTime())  
								   + "  ");
		menuDateLabel.setForeground(Color.blue);
		menuDateLabel.setFont(new Font("Verdana",Font.BOLD,14));

		// Header
		menuHeaderLabel = new JLabel("              Specials"
									+"              Price($$)"
									+"              Ordered");
		...
		menuGuideLabel = new JLabel("   Press the coressponding numbers marked by [ ]");
		menuGuideLabel.setForeground(Color.white);
		menuGuideLabel.setFont(new Font("Arial",Font.BOLD,16));	
	}

	//frame method
	public void launchFrame() {	

		menuFrame.setSize(300,550);
...
class SubTotal extends JFrame implements KeyListener {
	...
	public SubTotal() {
		...
		subTotalStoreLabel = new JLabel(" The Restaurant ");
		...
		//who is logged in
		subTotalCashierLabel = new JLabel("   Manager on Duty : " + Login.managerName);
		...
		// Header
		subTotalHeaderLabel = new JLabel("    SPECIALS"
										+"  Price/Unit"
										+"    Ordered"
										+"    Total($$)   ");
		...
		subTotalGrandTotalLabel = new JLabel(" Sub Total : USD " + grandTotal + "0");
		...
		// Simple instructions added for users
	...
	//frame launch events method
	public void launchFrame() {	

		subTotalFrame.setSize(300,550);
